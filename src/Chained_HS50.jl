...
@inline Chained_HS50_con1(x, l) = x[l+1]^2 + 2 * x[l+2] + 3 * x[l+3]^2 - 6
@inline Chained_HS50_con2(x, l) = x[l+2]^2 + 2 * x[l+3] + 3 * x[l+4] - 6
@inline Chained_HS50_con3(x, l) = x[l+3]^2 + 2 * x[l+4] + 3 * x[l+5] - 6
