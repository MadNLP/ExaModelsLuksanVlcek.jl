@inline function LV.Chained_HS47_model(::LV.JuMPBackend, N = 1000; optimizer = nothing, kwargs...)
    ...
    JuMP.@constraint(m, [l in It_L1], LV.Chained_HS47_con1(x, l) == 0)
    JuMP.@constraint(m, [l in It_L2], LV.Chained_HS47_con2(x, l) == 0)
    JuMP.@constraint(m, [l in It_L3], LV.Chained_HS47_con3(x, l) == 0)
